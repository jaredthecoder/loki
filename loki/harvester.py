...
class Harvester(object):
    ...
    def __init__(self, filter_type='location', location=[-167.344, -57.704, 178.594, 74.9594], keywords=None):
        ...
        self.auth.set_access_token(self.settings.ACCESS_TOKEN, self.settings.ACCESS_TOKEN_SECRET)
